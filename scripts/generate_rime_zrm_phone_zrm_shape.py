...
from common import SchemaConfig, ZRM_SP_SCHEMA, PINYIN_SCHEMA, ZRM_SHAPE_SCHEMA
...
def main():
    ...
    _, output_dir = sys.argv[0], "rime_ziranma_shuangpin_ziranma_xing"
    if not Path(output_dir).exists():
        os.makedirs(output_dir)

    std_schema_config = SchemaConfig(
        schema_id="xiaolu_zrm_shuangpin_zrm_xing",
        name="小鹭音形·自然码双拼+自然形",
