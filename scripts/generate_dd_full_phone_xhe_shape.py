...
if __name__ == "__main__":
    ...
    fname, output_dir = sys.argv[0], "full_phone_xhe_shape"
    ...
    with open(sys_single_char_data, 'w', encoding='utf8') as fout:
        ...
        pipe(
            ...
            map(
                lambda e: f"{e.char}\t{e.full+char_to_shape[e.char]}#序40000"),
    ...
    with open(sys_word_data, 'w', encoding='utf8') as fout:
        ...
        pipe(
            ...
            map(lambda e: (f'{e.word}\t{e.full}', e.word[0], e.word[-1])),
