...
def fill_bingji(item: WordPhoneTable, bingji: str) -> WordPhoneTable:
    item.bingji = bingji
    return item
...
if __name__ == "__main__":
    ...
    #    WordPhoneTable.select().where(WordPhoneTable.full == ""),
    #    map(lambda e: fill_full(e)),
    #)
    #with db.atomic():
    #    WordPhoneTable.bulk_update(to_update_full_items,
    #                               fields=['full'],
    #                               batch_size=100)
    ...
    #to_update_xhe_items = pipe(
    #    WordPhoneTable.select().where(WordPhoneTable.xhe == ""),
    ...
    #    WordPhoneTable.select().where(WordPhoneTable.zrm == ""),
    ...
    #    WordPhoneTable.select().where(WordPhoneTable.lu == ''),
